...
public enum VisualNotificationType {
    ...
    /*
     * Stat boost Notifications
     */
    ATTACK_BELOW_THRESHOLD("ATTACK_BELOW_THRESHOLD", 11),
    STRENGTH_BELOW_THRESHOLD("STRENGTH_BELOW_THRESHOLD", 10),
    RANGED_BELOW_THRESHOLD("RANGED_BELOW_THRESHOLD", 9),
    MAGIC_BELOW_THRESHOLD("MAGIC_BELOW_THRESHOLD", 8),
    ;
